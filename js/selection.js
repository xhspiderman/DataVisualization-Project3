...
function selection(){
	...
	$("#tags ul").append('<li><a href="#second" data-weight="11"' + '>' + 'Lisa Class' + '</a>' + '</li>');
	$("#tags ul").append('<li><a href="#fourth" data-weight="8"' + '>' + 'Bart Class' + '</a>' + '</li>');
	...
	$("#tags ul li a").click(function(selector) {
		...
		Characters_to_show =  characters_episodes_DB({page:group_select});
		if (type=="10") Characters_to_show = characters_episodes_DB().limit(10).order("totalAppear desc");
